...
const SITE_TITLE = "Centro de Especialidades Filipinho — SEMUS São Luís";
const SITE_DESC =
  "Atendimento ambulatorial e eletivo com 12 especialidades médicas e 6 não médicas em São Luís/MA. Qualidade e excelência em cada atendimento.";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Centro de Especialidades Filipinho" },
      ...
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/6a8vCQujcrhCjyT3wWnZnZokVAz2/social-images/social-1783520718076-imagem_ce_filipinho.webp" },
    ],
    links: [
